...
fig = figure(2);
Thrusters = GenerateBlueROVThrusters(optimSol, l, w, h,COB);
...
folderPath = 'C:\Users\Ottol\Documents\UIS\Master Thesis\Matlab_Master\Ottos_Matlab_eventyr\ROV_model\GA_Results\Optimal_Rotation_Gradient_Decent_BlueROV'; % Otto Laptop
...
function cost = CostFunction(l,w,h, COB, u, Gram_sys, reduced)
    ...
    Thrusters = GenerateBlueROVThrusters(u, l, w, h, COB);   
