...
[optimSol, fval] = ga(@(u)CostFunction(l, w, h, COB, u, Gram_sys,reduced), 24, [], [], [], [], lb, ub, [], [], options);
%%
fig = figure(2);
...
disp('Cost of corner thrusters at optimum:')
disp(Manual_Cost_2)

%% Saving the data
%folderPath = 'C:\Users\Tomas\MATLAB Drive\Ottos_Matlab_eventyr\ROV_model\GA_Results\Simpel_test'; % Tomas Desktop
folderPath = 'C:\Users\Ottol\Documents\UIS\Master Thesis\Matlab_Master\Ottos_Matlab_eventyr\ROV_model\GA_Results\opt_rot_weighted'; % Otto Laptop
